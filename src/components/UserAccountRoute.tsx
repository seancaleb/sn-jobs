...
const links = [
  ...
  },
  {
    label: "Applied Jobs",
    path: "applied-jobs",
    icon: <Briefcase className="mr-3 h-5 w-5" strokeWidth={2.5} />,
    role: "user",
  },
  {
    label: "Bookmarked Jobs",
    path: "bookmarked-jobs",
    icon: <Bookmark className="mr-3 h-5 w-5" strokeWidth={2.5} />,
    role: "user",
  },
  {
    label: "My Job Listings",
    path: "job-listings",
    icon: <ClipboardList className="mr-3 h-5 w-5" strokeWidth={2.5} />,
    role: "employer",
  },
  {
